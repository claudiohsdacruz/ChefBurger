...
void Ingredient::ingredientsAleatoires()
{
	...
	_ingredients[0].setPosition(1100, 380);
	_ingredients[0].setSize(Vector2f(85, 85));
	_ingredients[0].setTexture(&_vecteurIngredients.at(0));

	_ingredients[4].setPosition(1100, 185);
	_ingredients[4].setSize(Vector2f(85, 85));
	_ingredients[4].setTexture(&_vecteurIngredients.at(12));

	_ingredients[1].setTexture(&_vecteurIngredients.at(index));
	_ingredients[1].setPosition(1100, 245);
	_ingredients[1].setSize(Vector2f(85, 85));

	_ingredients[2].setTexture(&_vecteurIngredients.at(index1));
	_ingredients[2].setPosition(1100, 295);
	_ingredients[2].setSize(Vector2f(85, 85));

	_ingredients[3].setTexture(&_vecteurIngredients.at(index2));
	_ingredients[3].setPosition(1100, 345);
	_ingredients[3].setSize(Vector2f(85, 85));
