...
void Ingredient::drawIngredients(RenderWindow &window)
{
	/*int index = 0;
	int index1 = 0;
	int index2 = 0;*/
...
void Ingredient::ingredientsAleatoires()
{
	...
	_ingredients[0].setPosition(1000, 375);
	_ingredients[0].setSize(Vector2f(90, 90));
	_ingredients[0].setTexture(&_vecteurIngredients.at(0));

	_ingredients[4].setPosition(1000, 160);
	_ingredients[4].setSize(Vector2f(90, 90));
	_ingredients[4].setTexture(&_vecteurIngredients.at(11));

	_ingredients[1].setTexture(&_vecteurIngredients.at(index));
	_ingredients[1].setPosition(1000, 220);
	_ingredients[1].setSize(Vector2f(90, 90));

	_ingredients[2].setTexture(&_vecteurIngredients.at(index1));
	_ingredients[2].setPosition(1000, 270);
	_ingredients[2].setSize(Vector2f(90, 90));

	_ingredients[3].setTexture(&_vecteurIngredients.at(index2));
	_ingredients[3].setPosition(1000, 330);
	_ingredients[3].setSize(Vector2f(90, 90));
